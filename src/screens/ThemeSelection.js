...
const ThemeSelection = ({ navigation }) => {
  ...
  const [selectedTheme, setSelectedTheme] = useState("Blue - White");

  const themes = [
    { id: "Blue - White", label: "Blue - White" },
    { id: "Yellow - Black", label: "Yellow - Black" },
    { id: "Grey - White", label: "Grey - White" }
  ];

  const selectedIndex = themes.findIndex(t => t.id === selectedTheme);

  // Height of each item including vertical margins
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      >
        ...
        <View style={[styles.themeSelectionBox, { height: screenHeight * 0.22 }]}>
          <ScrollView
            showsVerticalScrollIndicator={false}
            contentContainerStyle={styles.themeListWrapper}
          ...
          >
            ...
            {themes.map((theme) => {
              ...
              return (
                <TouchableOpacity
                  key={theme.id}
                  style={[styles.themeItem, { width: sliderWidth }]}
                ...
                >
                  <Text
                    style={[
                      ...
                      isSelected && styles.selectedThemeItemText,
                    ]}
                  >
                    {theme.label}
                  </Text>
